export default function HelpIcon({ className, style, handleHelpHover }) {

  return (
    <svg className={className} style={style}  viewBox="0 0 24 24" onMouseEnter={handleHelpHover} onMouseLeave={handleHelpHover}>
